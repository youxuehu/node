...
import { convertAuditMetadataTo, PageResult } from '../model/audit';
...
export class AuditService {
    ...
    async queryByCondition(approver: string, applicant: string, name: string, startTime: string, endTime: string, page: number, pageSize: number): Promise<PageResult> {
        const result = await this.auditManager.queryByCondition(approver, applicant, name, startTime, endTime, page, pageSize)
        return {
